...
# ----------------------------
chords = {
    "HD":["F#dim7","E7#9","D9","F#9","G7","Abm","Gdim","E7b5","Ab+","C#11","Badd9","F#m11"],
    "DN":["Adim","G7#9","E9","D#9","B7","Em7","A#dim7","F7b9","G#+","D13","CM/9","C#m11"],
    "DC":["Cdim7","D7#9","D+","D9","CM7","Em6","G#m7b5","G#7","Db+","Eb9","Dadd9","F#m9"],
    "ND":["F#dim","F7#9","C+","G13","EM","Em9","G#dim7","D#7#9","B+","G11","BM/9","Cm7"],
    "CN":["Ddim","G#7#9","F+","C13","EM6","Em11","A#dim","Ab7#5","A#add9","F#13","FM/9","C#m9"],
    "HC":["Ddim7","F#7#9","A+","B13","DM9","Em7#5","Adim7","F#7b9","E+","F11","EM9","Gm9"],
    "CD":["Edim7","F7b5","G+","E11","BM9","Gm11","Em7b5","A7#9","D#+","G9","GM6","Dm9"],
    "CH":["D#dim","C#7#9","C9+","Eb11","FM9","Bm11","Fdim7","Eb7#5","F#add9","E13","E6/9","G#m11"],
    "NC":["G#dim","C7b9","B9+","Bb13","GM9","Bbm9","Bm7b5","G#9","F#+","A9","GM/9","A#m9"],
    "DH":["Bdim","Eb7#9","Aadd9","C11","DM/9","Fm11","Fdim","C7#9","Eadd9","B11","A6/9","G#m9"],
    "NH":["Bdim7","D#7","Cadd9","D11","D6/9","Am11","C#m7b5","G#13","C#+","F9","AM/9","A#m7"],
    "HN":["A#m7b5","B7b9","Dbm9","Bb9","G6/9","Ebm9","F#m7b5","Bb7#9","G#add9","Db9","F6/9","Fm9"]
}
...
def detect_intention_modes(sequence):
    ...
    return sorted(motif_gaps, key=lambda x: x[1])

# ----------------------------
# CHORD MAPPING (position-based)
# ----------------------------
...
def detect_key(sequence):
    ...
    best_pc = max(weights, key=weights.get)
...
# RUN EXAMPLE
# ----------------------------
sequence = ["HC", "HN", "HC", "ND", "CN"]

print("--- INTENTION MODES ---")
for motif, gap, count in detect_intention_modes(sequence):
    print(motif, gap, count)
